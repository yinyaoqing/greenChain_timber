# 🌲 綠鏈林匯 GreenChain Timber — 台灣森林信任公地

開源的森林碳匯數位 MRV（Measurement, Reporting, Verification）公共基礎設施——
讓每一筆森林碳匯主張**可量測、可驗證、任何人都能免費核對**。

**使命**：台灣的自然碳匯要能被社會信任，需要的不是更多機構背書，而是任何人可獨立驗證的公開底層。
本專案原始碼全開源、估算係數與空間圖層版本化可稽核，服務公民、保育組織、聚合單位（產銷班／合作社／公協會）、主管機關與企業——
提供的是額度產生前的公共數據信任基礎設施，不是個人碳權變現管道。
